        ...
        if ( response != null ) {
            ...
            try {
                ...
                if (httpResponse != null && !httpResponse.isOk()) {
                    ...
                    log.info("Unable to get the music track response from the http request, error: " + errorStr);
                }

            } catch (InterruptedException | ExecutionException e) {
                log.info("Unable to get the music track response from the http request, error: " + e.getMessage());
            }
        }
